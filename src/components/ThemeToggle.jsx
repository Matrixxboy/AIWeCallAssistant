...
function ThemeToggle({ className = '', size = 'md' }) {
  ...
  return (
    <Button
      onClick={toggleTheme}
      variant="bordered"
      className={`border-white/20 hover:bg-white/10 transition-all duration-300 interactive-scale ${className}`}
      size={size}
      isIconOnly
    ...
    >
      <div className="relative w-6 h-6 flex items-center justify-center">
        ...
        {isTransitioning && (
          <svg
            className="absolute w-5 h-5 text-gray-400 animate-spin"
            fill="none"
            viewBox="0 0 24 24"
          >
            <circle
